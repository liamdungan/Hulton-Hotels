...
try{
	...
	String temp = request.getParameter("breakfast");
	String params[]= temp.split(";");
	//out.print(Arrays.toString(params));
	String HotelID = params[1];
	String bType = params[0];
    ...
    PreparedStatement newRoomReview = con.prepareStatement("INSERT INTO BreakfastReview VALUES(?, ?, ?)");
    newRoomReview.setString(1 , ReviewID);
    newRoomReview.setString(2, bType);
